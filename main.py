...
app = FastAPI(
    ...
    description="A python API to to interact with Google Sheets",
    version="1.0",
    docs_url="/",
    openapi_tags=[
        {
            "name": "authentication",
            "description": "Authenticate clients to access th API"
        },
        {
            "name": "spreadsheets",
        ...
        {
            "name": "worksheets",
            "description": "Operations on worksheets within a given spreadsheets"
        }
    ],
